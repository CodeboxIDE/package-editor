define(function (_) {
    ...
    var Languages = {
         ...
         */
        getColorByInfos: function(infos, def) {
            var color = def;
            if (infos == null) {
                return def;
            }
            ...
            if (infos.group != null && infos.group != infos.lang) {
                return Languages.getColor(infos.group, def);
            }
            return def;
        },
         ...
         *  @lang : name of the language
         */
        getColor: function(lang, def) {
            var infos = Languages.get_infos(lang);
            return Languages.getColorByInfos(infos, def)
        },
         ...
         *  @ext : file extension
         */
        getColorByExt: function(ext, def) {
         ...
         *  @extension : extension of the file
         */
        getModeByExtension: function(extension) {
            var lang = Languages.getByExtension(extension);
